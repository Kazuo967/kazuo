...
const instagram = 'https://instagram.com/sadiddanfarhan'; 
const telegram = 'https://t.me/OnBite'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@sadiddanfarhan')
